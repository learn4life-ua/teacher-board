...
buildShapeMenu();bindShapeDrawing();bindGraphPanel();bindTextPanel();bindObjectEditing();bindImages();bindPageRename();bindResponsivePanel();bindUi();setTool(state.tool.startsWith('shape:')?'select':state.tool);renderAll();