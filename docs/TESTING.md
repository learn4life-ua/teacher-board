...
- math-only контракт графічних виразів;
...
- [x] Static Validate перевіряє `x^2`, `2*x-3`, `sin(x)`, `sqrt(x)`, `abs(x)`, `pi*x`.
...
- [ ] Побудований кут після drag/rotate має правильну геометрію.
- [ ] Циркуль рухається, повертається та змінює радіус пальцем.
- [ ] Візуально звірити радіус кола/дуги з розкриттям циркуля.
